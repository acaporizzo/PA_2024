...
primer_profesor = Profesor("Diana","Vertiz","45387222")
...
primer_estudiante = Estudiante("Ana Clara","Polari","11111111")
segundo_estudiante = Estudiante("Agustina","Wiesner","22222222")
tercer_estudiante = Estudiante("Pedro","Perez","33333333")
...
facultad.atribuir_director_a_dpto(segundo_profesor, "Dpto Programación")   
#prueba para cambiar el director y que se muestre solo uno
