...
lista_para_graficar = [] #Lista que va a contener tuplas con la información necesaria para graficar.
nombre_de_usuario = "" 
...
def respuestas():
    ...
    if contador_repeticiones == numero_de_opciones: #Cuando se termina la trivia se guardan los datos en un archivo .txt
        ...
        lista_para_graficar.append(valores) #Se guardan los datos necesarios para graficar.
...
def ver_resultados_graficos():
    ...
    if lista_para_graficar: #Si la lista no se encuantra vacía se van a utilizar las funciones para graficar.
